...
import { Target, Heart, Users, Lightbulb, GraduationCap, Apple } from 'lucide-react';

const MISSION_POINTS = [
  {
    icon: Target,
    title: "Direct Support",
    description: "We bypass bureaucracy to get funds directly into the hands of teachers who know their students' needs best.",
    color: "text-apple",
    bgColor: "bg-apple/10"
  },
  {
    icon: Heart,
    title: "Student-Led",
    description: "Driven by the energy and perspective of Michigan students who want to give back to the educators who shaped them.",
    color: "text-ruler",
    bgColor: "bg-ruler/10"
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    description: "We prioritize projects that bring modern technology and creative learning methods into Michigan classrooms.",
    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid lg:grid-cols-2 gap-24 items-center">
        ...
        >
          ...
          <h2 className="text-6xl font-serif font-bold mb-8 leading-[1.1] text-balance">
            Empowering Educators to <span className="text-apple italic font-normal">Inspire</span> the Next Generation.
          </h2>
<p className="text-xl text-chalkboard/70 mb-8 leading-relaxed font-light">
...
<p className="text-xl text-chalkboard/70 mb-12 leading-relaxed font-light">
...
<p className="text-xl text-chalkboard font-medium leading-relaxed">
  Together, we can transform the education landscape, empowering teachers to reach their full potential and inspire generations to come.
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            <div className="p-8 bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-chalkboard/5 group hover:border-apple/20 transition-colors">
              <div className="text-5xl font-serif font-bold text-apple mb-2 group-hover:scale-110 transition-transform origin-left">100%</div>
              <div className="text-[10px] font-bold text-muted uppercase tracking-[0.2em]">Direct to Classrooms</div>
            </div>
            <div className="p-8 bg-white rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-chalkboard/5 group hover:border-ruler/20 transition-colors">
              <div className="text-5xl font-serif font-bold text-ruler mb-2 group-hover:scale-110 transition-transform origin-left">3</div>
        ...
        <div className="space-y-8">
          {MISSION_POINTS.map((point, index) => (
            <motion.div
              ...
              className="group p-10 bg-white rounded-[40px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-chalkboard/5 hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] transition-all duration-500 flex gap-8 items-start"
            >
              <div className={`w-16 h-16 shrink-0 rounded-2xl ${point.bgColor} ${point.color} flex items-center justify-center group-hover:rotate-6 transition-transform duration-500 shadow-sm`}>
                <point.icon size={32} />
              </div>
              <div>
                <h3 className="text-2xl font-serif font-bold mb-3">{point.title}</h3>
                <p className="text-chalkboard/60 leading-relaxed font-light text-lg">
                  {point.description}
                </p>
              </div>
            </motion.div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-10 bg-chalkboard text-white rounded-[40px] shadow-2xl relative overflow-hidden group"
          >
