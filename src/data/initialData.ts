...
export const LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    district: 'Okemos Public Schools',
    impact: 'Teacher Appreciation Week — Chick-fil-A "Be our guest" meal cards delivered to all ~120 staff members.',
    amount: '~120 educators',
    lat: 42.7016, lng: -84.4172,
